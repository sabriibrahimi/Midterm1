...
public class Cake
{
    ...
    {
        SLLNode<Cakes> move = cakes.getFirst();
        int sum = 0;
        while(move!=null)
        {
            sum+=move.element.getCena();
            move=move.succ;
        }
        int prosek = sum/cakes.length();
        SLLNode<Cakes> price = cakes.getFirst();
        SLLNode<Cakes> help = null;
        while(price!=null)
        {
            if(price.element.getCena()>prosek)
            {
                cakes.delete(price);
            }
            price=price.succ;
