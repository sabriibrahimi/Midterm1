package Midterm1.removeNthFromEnd;
...
class  SLL<E> {
    ...
    public void removeNthFromEnd(int n) {
        ...
        for(int i = 0; i < n; i++){
            if(fast == null){
                System.out.println("Invalid input: n is greater" +
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the value of n to remove the nth node from the end: ");
